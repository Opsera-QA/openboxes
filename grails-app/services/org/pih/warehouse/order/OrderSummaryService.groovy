...
class OrderSummaryService {
        ...
        return """
            ...
            FROM (
                ...
                WHERE `order`.order_type_id = 'PURCHASE_ORDER'
                    AND `order`.id = '${orderId}'  // SEMGREP-OSS-001: pre-existing groovy-gstring-sql-string-literal (WARNING) — remediation in WO-SECURITY-001
    ...
    String getOrderSummarySelect(String orderId) {
        return """
            ...
            WHERE id = '${orderId}'  // SEMGREP-OSS-001: pre-existing groovy-gstring-sql-string-literal (WARNING) — remediation in WO-SECURITY-001
        """
    }
